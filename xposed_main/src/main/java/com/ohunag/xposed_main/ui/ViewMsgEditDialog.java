...
public class ViewMsgEditDialog {
    ...
    public ViewMsgEditDialog(Activity activity) {
        ...
        ll_viewMsg = (ViewGroup) LayoutInflater.from(activity).inflate(UiHook.xpRes.getLayout(R.layout.ui_main_window_view_msg), null, false);
    ...
    public void set_ll_viewMsg_edit(ViewNode viewNode) {

        listView_viewMsg.setAdapter(new ViewEditAdapter(viewNode, activity));
        tv_edit_viewMsg.setVisibility(View.GONE);
