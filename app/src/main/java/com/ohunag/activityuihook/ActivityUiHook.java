...
public class ActivityUiHook implements IXposedHookLoadPackage, IXposedHookZygoteInit, IXposedHookInitPackageResources {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        ...
        if (!isHook) {
            isHook = true;
            UiHook.init(null, xpRes, new UiHook.ViewListManager() {
                @Override
            ...
            }, UiHook.Type.XPOSED, lpparam.classLoader, true);
    ...
    private void hookUi(XC_LoadPackage.LoadPackageParam lpparam) {
